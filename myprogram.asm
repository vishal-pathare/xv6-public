...
//printf("Unix V6 was released in the year %d\n", getyear());
exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 574:	eb 1a                	jmp    590 <printf+0x1a0>
          s = "(null)";
 576:	bb 7d 07 00 00       	mov    $0x77d,%ebx
        while(*s != 0){
 ...
 5c1:	a1 28 0a 00 00       	mov    0xa28,%eax
{
 ...
 601:	5b                   	pop    %ebx
  freep = p;
 602:	89 15 28 0a 00 00    	mov    %edx,0xa28
}
 608:	5e                   	pop    %esi
 609:	5f                   	pop    %edi
 60a:	5d                   	pop    %ebp
 ...
 639:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 63c:	89 15 28 0a 00 00    	mov    %edx,0xa28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d 28 0a 00 00    	mov    0xa28,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6a7:	73 4f                	jae    6f8 <malloc+0xa8>
    ...
    if(p == freep)
 6a9:	8b 3d 28 0a 00 00    	mov    0xa28,%edi
 ...
 6d2:	e8 e9 fe ff ff       	call   5c0 <free>
  return freep;
 6d7:	a1 28 0a 00 00       	mov    0xa28,%eax
 ...
 704:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 707:	a3 28 0a 00 00       	mov    %eax,0xa28
}
 ...
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf 2c 0a 00 00       	mov    $0xa2c,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 2c 0a 00 00 2c 	movl   $0xa2c,0xa2c
 736:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 73b:	c7 05 30 0a 00 00 00 	movl   $0x0,0xa30
 742:	00 00 00 
    if(p->s.size >= nunits){
