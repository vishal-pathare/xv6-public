...
int main(int argc, char *argv[]) {
  ...
  20:	e8 eb 02 00 00       	call   310 <atoi>

    int len = atoi(argv[3]);
  25:	5f                   	pop    %edi
  26:	ff 73 0c             	pushl  0xc(%ebx)
    int offset = atoi(argv[2]);
  29:	89 85 74 ff ff ff    	mov    %eax,-0x8c(%ebp)
    int len = atoi(argv[3]);
  2f:	e8 dc 02 00 00       	call   310 <atoi>

    char *string = argv[4];
  34:	8b 7b 10             	mov    0x10(%ebx),%edi
    int len = atoi(argv[3]);
  ...
  3f:	6a 02                	push   $0x2
  41:	56                   	push   %esi
  42:	e8 7c 03 00 00       	call   3c3 <open>

    if (fd != -1) 
  47:	83 c4 10             	add    $0x10,%esp
  4a:	83 f8 ff             	cmp    $0xffffffff,%eax
  4d:	0f 84 a5 00 00 00    	je     f8 <main+0xf8>
  ...
  66:	6a 00                	push   $0x0
  68:	ff b5 74 ff ff ff    	pushl  -0x8c(%ebp)
  6e:	53                   	push   %ebx
  6f:	e8 b7 03 00 00       	call   42b <lseek>
  74:	83 c4 10             	add    $0x10,%esp
  77:	83 c0 01             	add    $0x1,%eax
  7a:	0f 84 8b 00 00 00    	je     10b <main+0x10b>
  ...
  80:	8d 75 84             	lea    -0x7c(%ebp),%esi
  83:	51                   	push   %ecx
  84:	ff b5 70 ff ff ff    	pushl  -0x90(%ebp)
  8a:	56                   	push   %esi
  8b:	53                   	push   %ebx
  8c:	e8 0a 03 00 00       	call   39b <read>
  ...
  b8:	56                   	push   %esi
  b9:	57                   	push   %edi
  ba:	e8 a1 00 00 00       	call   160 <strcmp>
  bf:	83 c4 10             	add    $0x10,%esp
  c2:	85 c0                	test   %eax,%eax
  c4:	74 1f                	je     e5 <main+0xe5>
  ...
  da:	53                   	push   %ebx
  db:	e8 cb 02 00 00       	call   3ab <close>

    exit();
  e0:	e8 9e 02 00 00       	call   383 <exit>
  ...
  f8:	53                   	push   %ebx
  f9:	53                   	push   %ebx
  fa:	68 72 08 00 00       	push   $0x872
  ff:	6a 01                	push   $0x1
 101:	e8 ea 03 00 00       	call   4f0 <printf>
        exit();
 106:	e8 78 02 00 00       	call   383 <exit>
        printf(1, "Lseek failed\n");
 10b:	51                   	push   %ecx
 10c:	51                   	push   %ecx
 10d:	68 8c 08 00 00       	push   $0x88c
 112:	6a 01                	push   $0x1
 114:	e8 d7 03 00 00       	call   4f0 <printf>
 119:	83 c4 10             	add    $0x10,%esp
 11c:	e9 5f ff ff ff       	jmp    80 <main+0x80>
...
printf(int fd, const char *fmt, ...)
{
 ...
 674:	eb 1a                	jmp    690 <printf+0x1a0>
          s = "(null)";
 676:	bb 0b 09 00 00       	mov    $0x90b,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c1:	a1 c4 0b 00 00       	mov    0xbc4,%eax
{
 ...
 701:	5b                   	pop    %ebx
  freep = p;
 702:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
}
 708:	5e                   	pop    %esi
 709:	5f                   	pop    %edi
 70a:	5d                   	pop    %ebp
 ...
 739:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 73c:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 3d c4 0b 00 00    	mov    0xbc4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7a7:	73 4f                	jae    7f8 <malloc+0xa8>
    ...
    if(p == freep)
 7a9:	8b 3d c4 0b 00 00    	mov    0xbc4,%edi
 ...
 7d2:	e8 e9 fe ff ff       	call   6c0 <free>
  return freep;
 7d7:	a1 c4 0b 00 00       	mov    0xbc4,%eax
