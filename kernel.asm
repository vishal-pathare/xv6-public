...
80100535:	68 05 74 10 80       	push   $0x80107405
...
8010058d:	e8 3e 59 00 00       	call   80105ed0 <uartputc>
  cgaputc(c);
...
80100606:	0f b6 92 30 74 10 80 	movzbl -0x7fef8bd0(%edx),%edx
  }while((x /= base) != 0);
...
80100647:	e8 84 58 00 00       	call   80105ed0 <uartputc>
  cgaputc(c);
...
8010072f:	0f 85 33 01 00 00    	jne    80100868 <cprintf+0x1e8>
        s = "(null)";
80100735:	bf 18 74 10 80       	mov    $0x80107418,%edi
      for(; *s; s++)
...
801007aa:	e8 21 57 00 00       	call   80105ed0 <uartputc>
  cgaputc(c);
...
801007f7:	e8 d4 56 00 00       	call   80105ed0 <uartputc>
  cgaputc(c);
...
80100838:	e8 93 56 00 00       	call   80105ed0 <uartputc>
  cgaputc(c);
...
80100883:	e8 48 56 00 00       	call   80105ed0 <uartputc>
  cgaputc(c);
...
801008af:	e8 1c 56 00 00       	call   80105ed0 <uartputc>
  cgaputc(c);
...
801008e6:	68 1f 74 10 80       	push   $0x8010741f
...
80100993:	e8 38 55 00 00       	call   80105ed0 <uartputc>
80100998:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010099f:	e8 2c 55 00 00       	call   80105ed0 <uartputc>
801009a4:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801009ab:	e8 20 55 00 00       	call   80105ed0 <uartputc>
  cgaputc(c);
...
80100a5d:	e8 6e 54 00 00       	call   80105ed0 <uartputc>
80100a62:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100a69:	e8 62 54 00 00       	call   80105ed0 <uartputc>
80100a6e:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100a75:	e8 56 54 00 00       	call   80105ed0 <uartputc>
  cgaputc(c);
...
80100ad5:	e8 f6 53 00 00       	call   80105ed0 <uartputc>
80100ada:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100ae1:	e8 ea 53 00 00       	call   80105ed0 <uartputc>
80100ae6:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100aed:	e8 de 53 00 00       	call   80105ed0 <uartputc>
  cgaputc(c);
...
80100b25:	e8 a6 53 00 00       	call   80105ed0 <uartputc>
  cgaputc(c);
...
80100b48:	e8 83 53 00 00       	call   80105ed0 <uartputc>
  cgaputc(c);
...
80100b86:	68 28 74 10 80       	push   $0x80107428
...
80100c52:	75 d2                	jne    80100c26 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100c54:	e8 07 64 00 00       	call   80107060 <setupkvm>
...
80100cc3:	e8 b8 61 00 00       	call   80106e80 <allocuvm>
...
80100cf9:	e8 92 60 00 00       	call   80106d90 <loaduvm>
...
80100d3b:	e8 a0 62 00 00       	call   80106fe0 <freevm>
  if(ip){
...
80100d82:	e8 f9 60 00 00       	call   80106e80 <allocuvm>
...
80100da1:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100da3:	e8 58 63 00 00       	call   80107100 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100e17:	e8 b4 64 00 00       	call   801072d0 <copyout>
...
80100e31:	e8 aa 61 00 00       	call   80106fe0 <freevm>
...
80100e7d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100e83:	e8 48 64 00 00       	call   801072d0 <copyout>
...
80100eed:	e8 0e 5d 00 00       	call   80106c00 <switchuvm>
  freevm(oldpgdir);
80100ef2:	89 3c 24             	mov    %edi,(%esp)
80100ef5:	e8 e6 60 00 00       	call   80106fe0 <freevm>
  return 0;
...
80100f0c:	68 41 74 10 80       	push   $0x80107441
...
80100f36:	68 4d 74 10 80       	push   $0x8010744d
...
80100ffb:	68 54 74 10 80       	push   $0x80107454
...
801010dc:	68 5c 74 10 80       	push   $0x8010745c
...
801011c2:	68 66 74 10 80       	push   $0x80107466
...
8010129b:	68 6f 74 10 80       	push   $0x8010746f
...
801012d1:	68 75 74 10 80       	push   $0x80107475
...
80101347:	68 7f 74 10 80       	push   $0x8010747f
...
80101404:	68 92 74 10 80       	push   $0x80107492
...
80101552:	68 a8 74 10 80       	push   $0x801074a8
...
80101625:	68 b8 74 10 80       	push   $0x801074b8
...
8010167c:	68 cb 74 10 80       	push   $0x801074cb
...
80101693:	68 d2 74 10 80       	push   $0x801074d2
...
80101703:	68 38 75 10 80       	push   $0x80107538
...
801017d3:	68 d8 74 10 80       	push   $0x801074d8
...
8010194d:	68 f0 74 10 80       	push   $0x801074f0
80101952:	e8 29 ea ff ff       	call   80100380 <panic>
    panic("ilock");
80101957:	83 ec 0c             	sub    $0xc,%esp
8010195a:	68 ea 74 10 80       	push   $0x801074ea
...
801019a7:	68 ff 74 10 80       	push   $0x801074ff
...
80101b63:	68 ff 74 10 80       	push   $0x801074ff
...
80101e82:	68 19 75 10 80       	push   $0x80107519
80101e87:	e8 f4 e4 ff ff       	call   80100380 <panic>
    panic("dirlookup not DIR");
80101e8c:	83 ec 0c             	sub    $0xc,%esp
80101e8f:	68 07 75 10 80       	push   $0x80107507
...
801020df:	68 ff 74 10 80       	push   $0x801074ff
...
8010218b:	68 28 75 10 80       	push   $0x80107528
80102190:	e8 eb e1 ff ff       	call   80100380 <panic>
    panic("dirlink");
80102195:	83 ec 0c             	sub    $0xc,%esp
80102198:	68 06 7b 10 80       	push   $0x80107b06
...
801022ab:	68 94 75 10 80       	push   $0x80107594
801022b0:	e8 cb e0 ff ff       	call   80100380 <panic>
    panic("idestart");
801022b5:	83 ec 0c             	sub    $0xc,%esp
801022b8:	68 8b 75 10 80       	push   $0x8010758b
...
801022d6:	68 a6 75 10 80       	push   $0x801075a6
...
8010252a:	68 f4 75 10 80       	push   $0x801075f4
...
8010265b:	68 26 76 10 80       	push   $0x80107626
...
8010272b:	68 2c 76 10 80       	push   $0x8010762c
...
8010283b:	0f b6 91 60 77 10 80 	movzbl -0x7fef88a0(%ecx),%edx
  shift ^= togglecode[data];
80102842:	0f b6 81 60 76 10 80 	movzbl -0x7fef89a0(%ecx),%eax
  shift |= shiftcode[data];
...
80102858:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
8010285b:	8b 04 85 40 76 10 80 	mov    -0x7fef89c0(,%eax,4),%eax
...
80102898:	31 c0                	xor    %eax,%eax
    shift &= ~(shiftcode[data] | E0ESC);
8010289a:	0f b6 91 60 77 10 80 	movzbl -0x7fef88a0(%ecx),%edx
...
80102dda:	68 60 78 10 80       	push   $0x80107860
...
80103037:	68 64 78 10 80       	push   $0x80107864
...
801030f1:	68 73 78 10 80       	push   $0x80107873
801030f6:	e8 85 d2 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
801030fb:	83 ec 0c             	sub    $0xc,%esp
801030fe:	68 89 78 10 80       	push   $0x80107889
...
80103128:	68 a4 78 10 80       	push   $0x801078a4
8010312d:	e8 4e d5 ff ff       	call   80100680 <cprintf>
  idtinit();       // load idt register
80103132:	e8 a9 29 00 00       	call   80105ae0 <idtinit>
...
80103153:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103156:	e8 95 3a 00 00       	call   80106bf0 <switchkvm>
  seginit();
8010315b:	e8 00 3a 00 00       	call   80106b60 <seginit>
  lapicinit();
...
801031b4:	e8 17 2c 00 00       	call   80105dd0 <uartinit>
  pinit();         // process table
801031b9:	e8 22 08 00 00       	call   801039e0 <pinit>
  tvinit();        // trap vectors
801031be:	e8 9d 28 00 00       	call   80105a60 <tvinit>
  binit();         // buffer cache
...
801032ce:	68 b8 78 10 80       	push   $0x801078b8
...
80103386:	68 bd 78 10 80       	push   $0x801078bd
...
801034a3:	68 c2 78 10 80       	push   $0x801078c2
...
801034d2:	68 b8 78 10 80       	push   $0x801078b8
...
80103508:	68 dc 78 10 80       	push   $0x801078dc
...
801035b0:	00 00 00 
  initlock(&p->lock, "pipe");
801035b3:	68 fb 78 10 80       	push   $0x801078fb
...
80103934:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103937:	c7 40 14 4e 5a 10 80 	movl   $0x80105a4e,0x14(%eax)
  p->context = (struct context*)sp;
...
801039e6:	68 00 79 10 80       	push   $0x80107900
...
80103ad3:	e8 88 35 00 00       	call   80107060 <setupkvm>
...
80103af1:	e8 1a 32 00 00       	call   80106d10 <inituvm>
...
80103b5f:	68 30 79 10 80       	push   $0x80107930
80103b64:	50                   	push   %eax
80103b65:	e8 d6 0d 00 00       	call   80104940 <safestrcpy>
  p->cwd = namei("/");
80103b6a:	c7 04 24 39 79 10 80 	movl   $0x80107939,(%esp)
...
80103ba3:	68 17 79 10 80       	push   $0x80107917
...
80103bdb:	e8 20 30 00 00       	call   80106c00 <switchuvm>
  return 0;
...
80103bfa:	e8 81 32 00 00       	call   80106e80 <allocuvm>
...
80103c1a:	e8 91 33 00 00       	call   80106fb0 <deallocuvm>
...
80103c68:	e8 e3 34 00 00       	call   80107150 <copyuvm>
...
80103da0:	e8 5b 2e 00 00       	call   80106c00 <switchuvm>
...
80103db2:	e8 e4 0b 00 00       	call   8010499b <swtch>
      switchkvm();
80103db7:	e8 34 2e 00 00       	call   80106bf0 <switchkvm>
      c->proc = 0;
...
80103fbd:	68 88 79 10 80       	push   $0x80107988
80103fc2:	e8 b9 c3 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103fc7:	83 ec 0c             	sub    $0xc,%esp
80103fca:	68 7b 79 10 80       	push   $0x8010797b
...
801040a9:	e8 32 2f 00 00       	call   80106fe0 <freevm>
        p->pid = 0;
...
80104100:	68 94 79 10 80       	push   $0x80107994
...
80104209:	68 9a 79 10 80       	push   $0x8010799a
8010420e:	e8 6d c1 ff ff       	call   80100380 <panic>
    panic("sleep");
80104213:	83 ec 0c             	sub    $0xc,%esp
80104216:	68 94 79 10 80       	push   $0x80107994
...
8010431b:	68 1f 7d 10 80       	push   $0x80107d1f
...
8010433c:	74 ea                	je     80104328 <procdump+0x28>
      state = "???";
8010433e:	ba ab 79 10 80       	mov    $0x801079ab,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104343:	83 f8 05             	cmp    $0x5,%eax
80104346:	77 11                	ja     80104359 <procdump+0x59>
80104348:	8b 14 85 0c 7a 10 80 	mov    -0x7fef85f4(,%eax,4),%edx
      state = "???";
8010434f:	b8 ab 79 10 80       	mov    $0x801079ab,%eax
...
8010435e:	68 af 79 10 80       	push   $0x801079af
...
8010439d:	68 01 74 10 80       	push   $0x80107401
...
801043ca:	68 24 7a 10 80       	push   $0x80107a24
...
80104605:	68 2f 7a 10 80       	push   $0x80107a2f
8010460a:	e8 71 bd ff ff       	call   80100380 <panic>
    panic("popcli");
8010460f:	83 ec 0c             	sub    $0xc,%esp
80104612:	68 46 7a 10 80       	push   $0x80107a46
...
8010467b:	68 4d 7a 10 80       	push   $0x80107a4d
...
80104770:	68 55 7a 10 80       	push   $0x80107a55
...
80104b9c:	8b 14 85 80 7a 10 80 	mov    -0x7fef8580(,%eax,4),%edx
...
80104bc8:	68 5d 7a 10 80       	push   $0x80107a5d
...
80104d24:	68 fc 7a 10 80       	push   $0x80107afc
...
80104d3c:	68 fb 7a 10 80       	push   $0x80107afb
...
80104d51:	68 ef 7a 10 80       	push   $0x80107aef
...
80104d6f:	68 fe 7a 10 80       	push   $0x80107afe
80104d74:	e8 07 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104d79:	83 ec 0c             	sub    $0xc,%esp
80104d7c:	68 e0 7a 10 80       	push   $0x80107ae0
...
8010517d:	58                   	pop    %eax
8010517e:	5a                   	pop    %edx
8010517f:	68 fc 7a 10 80       	push   $0x80107afc
...
80105198:	68 fb 7a 10 80       	push   $0x80107afb
...
801057be:	e8 7d f2 ff ff       	call   80104a40 <argint>
801057c3:	83 c4 10             	add    $0x10,%esp
801057c6:	85 c0                	test   %eax,%eax
801057c8:	0f 88 a2 00 00 00    	js     80105870 <sys_lseek+0xc0>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
801057ce:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
801057d2:	0f 87 98 00 00 00    	ja     80105870 <sys_lseek+0xc0>
801057d8:	e8 b3 e2 ff ff       	call   80103a90 <myproc>
801057dd:	8b 55 f4             	mov    -0xc(%ebp),%edx
801057e0:	8b 74 90 28          	mov    0x28(%eax,%edx,4),%esi
  int offset;
  int type;
  struct file *file = 0;
  int new_offset;
...
801057ed:	e8 4e f2 ff ff       	call   80104a40 <argint>
  argint(2, &type);
801057f2:	58                   	pop    %eax
801057f3:	5a                   	pop    %edx
801057f4:	53                   	push   %ebx
801057f5:	6a 02                	push   $0x2
801057f7:	e8 44 f2 ff ff       	call   80104a40 <argint>

  if (type == SEEK_CUR) {
801057fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057ff:	83 c4 10             	add    $0x10,%esp
80105802:	83 f8 01             	cmp    $0x1,%eax
80105805:	74 19                	je     80105820 <sys_lseek+0x70>
...
8010580a:	74 2c                	je     80105838 <sys_lseek+0x88>
...
8010580c:	8b 45 f0             	mov    -0x10(%ebp),%eax
  ...
  file->off = offset;
8010580f:	89 c2                	mov    %eax,%edx
80105811:	89 56 14             	mov    %edx,0x14(%esi)

  return new_offset;

80105814:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105817:	5b                   	pop    %ebx
80105818:	5e                   	pop    %esi
80105819:	5d                   	pop    %ebp
8010581a:	c3                   	ret    
...
80105823:	8b 46 14             	mov    0x14(%esi),%eax
  file->off = offset;
80105826:	89 56 14             	mov    %edx,0x14(%esi)
80105829:	8d 65 f8             	lea    -0x8(%ebp),%esp
    new_offset = file->off + offset;
8010582c:	01 d0                	add    %edx,%eax
8010582e:	5b                   	pop    %ebx
8010582f:	5e                   	pop    %esi
80105830:	5d                   	pop    %ebp
80105831:	c3                   	ret    
...
8010583b:	ff 76 10             	pushl  0x10(%esi)
8010583e:	e8 4d c0 ff ff       	call   80101890 <ilock>
		new_offset = file->ip->size + offset;
80105843:	8b 56 10             	mov    0x10(%esi),%edx
80105846:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105849:	03 42 58             	add    0x58(%edx),%eax
		iunlock(file->ip);    
8010584c:	89 14 24             	mov    %edx,(%esp)
		new_offset = file->ip->size + offset;
8010584f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		iunlock(file->ip);    
80105852:	e8 19 c1 ff ff       	call   80101970 <iunlock>
  file->off = offset;
80105857:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010585a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010585d:	83 c4 10             	add    $0x10,%esp
80105860:	89 56 14             	mov    %edx,0x14(%esi)
...
80105872:	e9 6d ff ff ff       	jmp    801057e4 <sys_lseek+0x34>
...
{
  return fork();
80105880:	e9 ab e3 ff ff       	jmp    80103c30 <fork>
...
80105893:	83 ec 08             	sub    $0x8,%esp
  exit();
80105896:	e8 15 e6 ff ff       	call   80103eb0 <exit>
...
{
  return wait();
801058a0:	e9 3b e7 ff ff       	jmp    80103fe0 <wait>
...
801058ce:	e8 ad e9 ff ff       	call   80104280 <kill>
...
801058f3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801058f6:	e8 95 e1 ff ff       	call   80103a90 <myproc>
...
80105917:	78 27                	js     80105940 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105919:	e8 72 e1 ff ff       	call   80103a90 <myproc>
  if(growproc(n) < 0)
...
80105926:	e8 85 e2 ff ff       	call   80103bb0 <growproc>
...
80105975:	e8 46 ed ff ff       	call   801046c0 <acquire>
  ticks0 = ticks;
...
8010599d:	e8 be e7 ff ff       	call   80104160 <sleep>
  while(ticks - ticks0 < n){
...
801059af:	73 2f                	jae    801059e0 <sys_sleep+0x90>
    if(myproc()->killed){
801059b1:	e8 da e0 ff ff       	call   80103a90 <myproc>
...
801059c5:	e8 96 ec ff ff       	call   80104660 <release>
  }
  release(&tickslock);
  return 0;
}
...
801059e8:	e8 73 ec ff ff       	call   80104660 <release>
  return 0;
...
80105a30 <sys_getyear>:

int
sys_getyear(void)
{
return 1975;
80105a30:	b8 b7 07 00 00       	mov    $0x7b7,%eax
80105a35:	c3                   	ret    
...
80105a37:	06                   	push   %es
  pushl %fs
80105a38:	0f a0                	push   %fs
  pushl %gs
80105a3a:	0f a8                	push   %gs
  pushal
80105a3c:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105a3d:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105a41:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105a43:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105a45:	54                   	push   %esp
  call trap
80105a46:	e8 c5 00 00 00       	call   80105b10 <trap>
  addl $4, %esp
...
80105a77:	c7 04 c5 c2 3c 11 80 	movl   $0x8e000008,-0x7feec33e(,%eax,8)
80105a7e:	08 00 00 8e 
80105a82:	66 89 14 c5 c0 3c 11 	mov    %dx,-0x7feec340(,%eax,8)
80105a89:	80 
80105a8a:	c1 ea 10             	shr    $0x10,%edx
80105a8d:	66 89 14 c5 c6 3c 11 	mov    %dx,-0x7feec33a(,%eax,8)
80105a94:	80 
  for(i = 0; i < 256; i++)
...
80105aa7:	c7 05 c2 3e 11 80 08 	movl   $0xef000008,0x80113ec2
80105aae:	00 00 ef 
  initlock(&tickslock, "time");
80105ab1:	68 41 7b 10 80       	push   $0x80107b41
80105ab6:	68 80 3c 11 80       	push   $0x80113c80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105abb:	66 a3 c0 3e 11 80    	mov    %ax,0x80113ec0
80105ac1:	c1 e8 10             	shr    $0x10,%eax
80105ac4:	66 a3 c6 3e 11 80    	mov    %ax,0x80113ec6
  initlock(&tickslock, "time");
80105aca:	e8 21 ea ff ff       	call   801044f0 <initlock>
}
...
80105aeb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105aef:	b8 c0 3c 11 80       	mov    $0x80113cc0,%eax
...
80105b34:	ff 24 85 e8 7b 10 80 	jmp    *-0x7fef8418(,%eax,4)
...
80105b3f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105b40:	e8 0b c8 ff ff       	call   80102350 <ideintr>
    lapiceoi();
80105b45:	e8 d6 ce ff ff       	call   80102a20 <lapiceoi>
  }
...
80105b4a:	e8 41 df ff ff       	call   80103a90 <myproc>
80105b4f:	85 c0                	test   %eax,%eax
80105b51:	74 1d                	je     80105b70 <trap+0x60>
80105b53:	e8 38 df ff ff       	call   80103a90 <myproc>
...
80105b6a:	0f 84 e8 01 00 00    	je     80105d58 <trap+0x248>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105b70:	e8 1b df ff ff       	call   80103a90 <myproc>
80105b75:	85 c0                	test   %eax,%eax
80105b77:	74 0f                	je     80105b88 <trap+0x78>
80105b79:	e8 12 df ff ff       	call   80103a90 <myproc>
...
80105b82:	0f 84 b8 00 00 00    	je     80105c40 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b88:	e8 03 df ff ff       	call   80103a90 <myproc>
80105b8d:	85 c0                	test   %eax,%eax
80105b8f:	74 1d                	je     80105bae <trap+0x9e>
80105b91:	e8 fa de ff ff       	call   80103a90 <myproc>
...
80105bca:	0f 84 a2 01 00 00    	je     80105d72 <trap+0x262>
80105bd0:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105bd4:	0f 84 98 01 00 00    	je     80105d72 <trap+0x262>
...
80105be0:	e8 8b de ff ff       	call   80103a70 <cpuid>
...
80105bf1:	e8 9a de ff ff       	call   80103a90 <myproc>
80105bf6:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105bf9:	e8 92 de ff ff       	call   80103a90 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105c07:	ff 75 e4             	pushl  -0x1c(%ebp)
...
80105c15:	68 a4 7b 10 80       	push   $0x80107ba4
80105c1a:	e8 61 aa ff ff       	call   80100680 <cprintf>
    myproc()->killed = 1;
80105c1f:	83 c4 20             	add    $0x20,%esp
80105c22:	e8 69 de ff ff       	call   80103a90 <myproc>
80105c27:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c2e:	e8 5d de ff ff       	call   80103a90 <myproc>
...
80105c5f:	e8 0c de ff ff       	call   80103a70 <cpuid>
80105c64:	57                   	push   %edi
80105c65:	56                   	push   %esi
80105c66:	50                   	push   %eax
80105c67:	68 4c 7b 10 80       	push   $0x80107b4c
80105c6c:	e8 0f aa ff ff       	call   80100680 <cprintf>
    lapiceoi();
80105c71:	e8 aa cd ff ff       	call   80102a20 <lapiceoi>
    break;
80105c76:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c79:	e8 12 de ff ff       	call   80103a90 <myproc>
...
80105c9a:	0f 85 c8 00 00 00    	jne    80105d68 <trap+0x258>
    myproc()->tf = tf;
80105ca0:	e8 eb dd ff ff       	call   80103a90 <myproc>
80105ca5:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105ca8:	e8 d3 ee ff ff       	call   80104b80 <syscall>
    if(myproc()->killed)
80105cad:	e8 de dd ff ff       	call   80103a90 <myproc>
...
80105cc3:	5d                   	pop    %ebp
      exit();
80105cc4:	e9 e7 e1 ff ff       	jmp    80103eb0 <exit>
80105cc9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105cd0:	e8 5b 02 00 00       	call   80105f30 <uartintr>
    lapiceoi();
80105cd5:	e8 46 cd ff ff       	call   80102a20 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cda:	e8 b1 dd ff ff       	call   80103a90 <myproc>
...
80105cec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105cf0:	e8 eb cb ff ff       	call   801028e0 <kbdintr>
    lapiceoi();
80105cf5:	e8 26 cd ff ff       	call   80102a20 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cfa:	e8 91 dd ff ff       	call   80103a90 <myproc>
...
80105d0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105d10:	e8 5b dd ff ff       	call   80103a70 <cpuid>
80105d15:	85 c0                	test   %eax,%eax
80105d17:	0f 85 28 fe ff ff    	jne    80105b45 <trap+0x35>
      acquire(&tickslock);
80105d1d:	83 ec 0c             	sub    $0xc,%esp
80105d20:	68 80 3c 11 80       	push   $0x80113c80
80105d25:	e8 96 e9 ff ff       	call   801046c0 <acquire>
      wakeup(&ticks);
80105d2a:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
      ticks++;
80105d31:	83 05 60 3c 11 80 01 	addl   $0x1,0x80113c60
      wakeup(&ticks);
80105d38:	e8 e3 e4 ff ff       	call   80104220 <wakeup>
      release(&tickslock);
80105d3d:	c7 04 24 80 3c 11 80 	movl   $0x80113c80,(%esp)
80105d44:	e8 17 e9 ff ff       	call   80104660 <release>
80105d49:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105d4c:	e9 f4 fd ff ff       	jmp    80105b45 <trap+0x35>
80105d51:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80105d58:	e8 53 e1 ff ff       	call   80103eb0 <exit>
80105d5d:	e9 0e fe ff ff       	jmp    80105b70 <trap+0x60>
80105d62:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105d68:	e8 43 e1 ff ff       	call   80103eb0 <exit>
80105d6d:	e9 2e ff ff ff       	jmp    80105ca0 <trap+0x190>
80105d72:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105d75:	e8 f6 dc ff ff       	call   80103a70 <cpuid>
80105d7a:	83 ec 0c             	sub    $0xc,%esp
80105d7d:	56                   	push   %esi
80105d7e:	57                   	push   %edi
80105d7f:	50                   	push   %eax
80105d80:	ff 73 30             	pushl  0x30(%ebx)
80105d83:	68 70 7b 10 80       	push   $0x80107b70
80105d88:	e8 f3 a8 ff ff       	call   80100680 <cprintf>
      panic("trap");
80105d8d:	83 c4 14             	add    $0x14,%esp
80105d90:	68 46 7b 10 80       	push   $0x80107b46
...
80105e27:	0f 84 93 00 00 00    	je     80105ec0 <uartinit+0xf0>
  uart = 1;
80105e2d:	c7 05 c0 44 11 80 01 	movl   $0x1,0x801144c0
80105e34:	00 00 00 
...
80105e40:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105e43:	bf 68 7c 10 80       	mov    $0x80107c68,%edi
80105e48:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105e4d:	6a 00                	push   $0x0
80105e4f:	6a 04                	push   $0x4
80105e51:	e8 3a c7 ff ff       	call   80102590 <ioapicenable>
80105e56:	c6 45 e7 76          	movb   $0x76,-0x19(%ebp)
80105e5a:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105e5d:	c6 45 e6 78          	movb   $0x78,-0x1a(%ebp)
80105e61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105e68:	a1 c0 44 11 80       	mov    0x801144c0,%eax
80105e6d:	bb 80 00 00 00       	mov    $0x80,%ebx
80105e72:	85 c0                	test   %eax,%eax
80105e74:	75 1c                	jne    80105e92 <uartinit+0xc2>
80105e76:	eb 2b                	jmp    80105ea3 <uartinit+0xd3>
80105e78:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105e7f:	90                   	nop
    microdelay(10);
80105e80:	83 ec 0c             	sub    $0xc,%esp
80105e83:	6a 0a                	push   $0xa
80105e85:	e8 b6 cb ff ff       	call   80102a40 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105e8a:	83 c4 10             	add    $0x10,%esp
80105e8d:	83 eb 01             	sub    $0x1,%ebx
80105e90:	74 07                	je     80105e99 <uartinit+0xc9>
80105e92:	89 f2                	mov    %esi,%edx
80105e94:	ec                   	in     (%dx),%al
80105e95:	a8 20                	test   $0x20,%al
80105e97:	74 e7                	je     80105e80 <uartinit+0xb0>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105e99:	0f b6 45 e6          	movzbl -0x1a(%ebp),%eax
80105e9d:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105ea2:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
80105ea3:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
80105ea7:	83 c7 01             	add    $0x1,%edi
80105eaa:	84 c0                	test   %al,%al
80105eac:	74 12                	je     80105ec0 <uartinit+0xf0>
80105eae:	88 45 e6             	mov    %al,-0x1a(%ebp)
80105eb1:	0f b6 47 01          	movzbl 0x1(%edi),%eax
80105eb5:	88 45 e7             	mov    %al,-0x19(%ebp)
80105eb8:	eb ae                	jmp    80105e68 <uartinit+0x98>
...
80105ef5:	e8 46 cb ff ff       	call   80102a40 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
...
80105f36:	68 a0 5d 10 80       	push   $0x80105da0
80105f3b:	e8 b0 a9 ff ff       	call   801008f0 <consoleintr>
}
...
80105f47:	6a 00                	push   $0x0
  jmp alltraps
80105f49:	e9 e8 fa ff ff       	jmp    80105a36 <alltraps>
...
80105f50:	6a 01                	push   $0x1
  jmp alltraps
80105f52:	e9 df fa ff ff       	jmp    80105a36 <alltraps>
...
80105f59:	6a 02                	push   $0x2
  jmp alltraps
80105f5b:	e9 d6 fa ff ff       	jmp    80105a36 <alltraps>
...
80105f62:	6a 03                	push   $0x3
  jmp alltraps
80105f64:	e9 cd fa ff ff       	jmp    80105a36 <alltraps>
...
80105f6b:	6a 04                	push   $0x4
  jmp alltraps
80105f6d:	e9 c4 fa ff ff       	jmp    80105a36 <alltraps>
...
80105f74:	6a 05                	push   $0x5
  jmp alltraps
80105f76:	e9 bb fa ff ff       	jmp    80105a36 <alltraps>
...
80105f7d:	6a 06                	push   $0x6
  jmp alltraps
80105f7f:	e9 b2 fa ff ff       	jmp    80105a36 <alltraps>
...
80105f86:	6a 07                	push   $0x7
  jmp alltraps
80105f88:	e9 a9 fa ff ff       	jmp    80105a36 <alltraps>
...
80105f8d:	6a 08                	push   $0x8
  jmp alltraps
80105f8f:	e9 a2 fa ff ff       	jmp    80105a36 <alltraps>
...
80105f96:	6a 09                	push   $0x9
  jmp alltraps
80105f98:	e9 99 fa ff ff       	jmp    80105a36 <alltraps>
...
80105f9d:	6a 0a                	push   $0xa
  jmp alltraps
80105f9f:	e9 92 fa ff ff       	jmp    80105a36 <alltraps>
...
80105fa4:	6a 0b                	push   $0xb
  jmp alltraps
80105fa6:	e9 8b fa ff ff       	jmp    80105a36 <alltraps>
...
80105fab:	6a 0c                	push   $0xc
  jmp alltraps
80105fad:	e9 84 fa ff ff       	jmp    80105a36 <alltraps>
...
80105fb2:	6a 0d                	push   $0xd
  jmp alltraps
80105fb4:	e9 7d fa ff ff       	jmp    80105a36 <alltraps>
...
80105fb9:	6a 0e                	push   $0xe
  jmp alltraps
80105fbb:	e9 76 fa ff ff       	jmp    80105a36 <alltraps>
...
80105fc2:	6a 0f                	push   $0xf
  jmp alltraps
80105fc4:	e9 6d fa ff ff       	jmp    80105a36 <alltraps>
...
80105fcb:	6a 10                	push   $0x10
  jmp alltraps
80105fcd:	e9 64 fa ff ff       	jmp    80105a36 <alltraps>
...
80105fd2:	6a 11                	push   $0x11
  jmp alltraps
80105fd4:	e9 5d fa ff ff       	jmp    80105a36 <alltraps>
...
80105fdb:	6a 12                	push   $0x12
  jmp alltraps
80105fdd:	e9 54 fa ff ff       	jmp    80105a36 <alltraps>
...
80105fe4:	6a 13                	push   $0x13
  jmp alltraps
80105fe6:	e9 4b fa ff ff       	jmp    80105a36 <alltraps>
...
80105fed:	6a 14                	push   $0x14
  jmp alltraps
80105fef:	e9 42 fa ff ff       	jmp    80105a36 <alltraps>
...
80105ff6:	6a 15                	push   $0x15
  jmp alltraps
80105ff8:	e9 39 fa ff ff       	jmp    80105a36 <alltraps>
...
80105fff:	6a 16                	push   $0x16
  jmp alltraps
80106001:	e9 30 fa ff ff       	jmp    80105a36 <alltraps>
...
80106008:	6a 17                	push   $0x17
  jmp alltraps
8010600a:	e9 27 fa ff ff       	jmp    80105a36 <alltraps>
...
80106011:	6a 18                	push   $0x18
  jmp alltraps
80106013:	e9 1e fa ff ff       	jmp    80105a36 <alltraps>
...
8010601a:	6a 19                	push   $0x19
  jmp alltraps
8010601c:	e9 15 fa ff ff       	jmp    80105a36 <alltraps>
...
80106023:	6a 1a                	push   $0x1a
  jmp alltraps
80106025:	e9 0c fa ff ff       	jmp    80105a36 <alltraps>
...
8010602c:	6a 1b                	push   $0x1b
  jmp alltraps
8010602e:	e9 03 fa ff ff       	jmp    80105a36 <alltraps>
...
80106035:	6a 1c                	push   $0x1c
  jmp alltraps
80106037:	e9 fa f9 ff ff       	jmp    80105a36 <alltraps>
...
8010603e:	6a 1d                	push   $0x1d
  jmp alltraps
80106040:	e9 f1 f9 ff ff       	jmp    80105a36 <alltraps>
...
80106047:	6a 1e                	push   $0x1e
  jmp alltraps
80106049:	e9 e8 f9 ff ff       	jmp    80105a36 <alltraps>
...
80106050:	6a 1f                	push   $0x1f
  jmp alltraps
80106052:	e9 df f9 ff ff       	jmp    80105a36 <alltraps>
...
80106059:	6a 20                	push   $0x20
  jmp alltraps
8010605b:	e9 d6 f9 ff ff       	jmp    80105a36 <alltraps>
...
80106062:	6a 21                	push   $0x21
  jmp alltraps
80106064:	e9 cd f9 ff ff       	jmp    80105a36 <alltraps>
...
8010606b:	6a 22                	push   $0x22
  jmp alltraps
8010606d:	e9 c4 f9 ff ff       	jmp    80105a36 <alltraps>
...
80106074:	6a 23                	push   $0x23
  jmp alltraps
80106076:	e9 bb f9 ff ff       	jmp    80105a36 <alltraps>
...
8010607d:	6a 24                	push   $0x24
  jmp alltraps
8010607f:	e9 b2 f9 ff ff       	jmp    80105a36 <alltraps>
...
80106086:	6a 25                	push   $0x25
  jmp alltraps
80106088:	e9 a9 f9 ff ff       	jmp    80105a36 <alltraps>
...
8010608f:	6a 26                	push   $0x26
  jmp alltraps
80106091:	e9 a0 f9 ff ff       	jmp    80105a36 <alltraps>
...
80106098:	6a 27                	push   $0x27
  jmp alltraps
8010609a:	e9 97 f9 ff ff       	jmp    80105a36 <alltraps>
...
801060a1:	6a 28                	push   $0x28
  jmp alltraps
801060a3:	e9 8e f9 ff ff       	jmp    80105a36 <alltraps>
...
801060aa:	6a 29                	push   $0x29
  jmp alltraps
801060ac:	e9 85 f9 ff ff       	jmp    80105a36 <alltraps>
...
801060b3:	6a 2a                	push   $0x2a
  jmp alltraps
801060b5:	e9 7c f9 ff ff       	jmp    80105a36 <alltraps>
...
801060bc:	6a 2b                	push   $0x2b
  jmp alltraps
801060be:	e9 73 f9 ff ff       	jmp    80105a36 <alltraps>
...
801060c5:	6a 2c                	push   $0x2c
  jmp alltraps
801060c7:	e9 6a f9 ff ff       	jmp    80105a36 <alltraps>
...
801060ce:	6a 2d                	push   $0x2d
  jmp alltraps
801060d0:	e9 61 f9 ff ff       	jmp    80105a36 <alltraps>
...
801060d7:	6a 2e                	push   $0x2e
  jmp alltraps
801060d9:	e9 58 f9 ff ff       	jmp    80105a36 <alltraps>
...
801060e0:	6a 2f                	push   $0x2f
  jmp alltraps
801060e2:	e9 4f f9 ff ff       	jmp    80105a36 <alltraps>
...
801060e9:	6a 30                	push   $0x30
  jmp alltraps
801060eb:	e9 46 f9 ff ff       	jmp    80105a36 <alltraps>
...
801060f2:	6a 31                	push   $0x31
  jmp alltraps
801060f4:	e9 3d f9 ff ff       	jmp    80105a36 <alltraps>
...
801060fb:	6a 32                	push   $0x32
  jmp alltraps
801060fd:	e9 34 f9 ff ff       	jmp    80105a36 <alltraps>
...
80106104:	6a 33                	push   $0x33
  jmp alltraps
80106106:	e9 2b f9 ff ff       	jmp    80105a36 <alltraps>
...
8010610d:	6a 34                	push   $0x34
  jmp alltraps
8010610f:	e9 22 f9 ff ff       	jmp    80105a36 <alltraps>
...
80106116:	6a 35                	push   $0x35
  jmp alltraps
80106118:	e9 19 f9 ff ff       	jmp    80105a36 <alltraps>
...
8010611f:	6a 36                	push   $0x36
  jmp alltraps
80106121:	e9 10 f9 ff ff       	jmp    80105a36 <alltraps>
...
80106128:	6a 37                	push   $0x37
  jmp alltraps
8010612a:	e9 07 f9 ff ff       	jmp    80105a36 <alltraps>
...
80106131:	6a 38                	push   $0x38
  jmp alltraps
80106133:	e9 fe f8 ff ff       	jmp    80105a36 <alltraps>
...
8010613a:	6a 39                	push   $0x39
  jmp alltraps
8010613c:	e9 f5 f8 ff ff       	jmp    80105a36 <alltraps>
...
80106143:	6a 3a                	push   $0x3a
  jmp alltraps
80106145:	e9 ec f8 ff ff       	jmp    80105a36 <alltraps>
...
8010614c:	6a 3b                	push   $0x3b
  jmp alltraps
8010614e:	e9 e3 f8 ff ff       	jmp    80105a36 <alltraps>
...
80106155:	6a 3c                	push   $0x3c
  jmp alltraps
80106157:	e9 da f8 ff ff       	jmp    80105a36 <alltraps>
...
8010615e:	6a 3d                	push   $0x3d
  jmp alltraps
80106160:	e9 d1 f8 ff ff       	jmp    80105a36 <alltraps>
...
80106167:	6a 3e                	push   $0x3e
  jmp alltraps
80106169:	e9 c8 f8 ff ff       	jmp    80105a36 <alltraps>
...
80106170:	6a 3f                	push   $0x3f
  jmp alltraps
80106172:	e9 bf f8 ff ff       	jmp    80105a36 <alltraps>
...
80106179:	6a 40                	push   $0x40
  jmp alltraps
8010617b:	e9 b6 f8 ff ff       	jmp    80105a36 <alltraps>
...
80106182:	6a 41                	push   $0x41
  jmp alltraps
80106184:	e9 ad f8 ff ff       	jmp    80105a36 <alltraps>
...
8010618b:	6a 42                	push   $0x42
  jmp alltraps
8010618d:	e9 a4 f8 ff ff       	jmp    80105a36 <alltraps>
...
80106194:	6a 43                	push   $0x43
  jmp alltraps
80106196:	e9 9b f8 ff ff       	jmp    80105a36 <alltraps>
...
8010619d:	6a 44                	push   $0x44
  jmp alltraps
8010619f:	e9 92 f8 ff ff       	jmp    80105a36 <alltraps>
...
801061a6:	6a 45                	push   $0x45
  jmp alltraps
801061a8:	e9 89 f8 ff ff       	jmp    80105a36 <alltraps>
...
801061af:	6a 46                	push   $0x46
  jmp alltraps
801061b1:	e9 80 f8 ff ff       	jmp    80105a36 <alltraps>
...
801061b8:	6a 47                	push   $0x47
  jmp alltraps
801061ba:	e9 77 f8 ff ff       	jmp    80105a36 <alltraps>
...
801061c1:	6a 48                	push   $0x48
  jmp alltraps
801061c3:	e9 6e f8 ff ff       	jmp    80105a36 <alltraps>
...
801061ca:	6a 49                	push   $0x49
  jmp alltraps
801061cc:	e9 65 f8 ff ff       	jmp    80105a36 <alltraps>
...
801061d3:	6a 4a                	push   $0x4a
  jmp alltraps
801061d5:	e9 5c f8 ff ff       	jmp    80105a36 <alltraps>
...
801061dc:	6a 4b                	push   $0x4b
  jmp alltraps
801061de:	e9 53 f8 ff ff       	jmp    80105a36 <alltraps>
...
801061e5:	6a 4c                	push   $0x4c
  jmp alltraps
801061e7:	e9 4a f8 ff ff       	jmp    80105a36 <alltraps>
...
801061ee:	6a 4d                	push   $0x4d
  jmp alltraps
801061f0:	e9 41 f8 ff ff       	jmp    80105a36 <alltraps>
...
801061f7:	6a 4e                	push   $0x4e
  jmp alltraps
801061f9:	e9 38 f8 ff ff       	jmp    80105a36 <alltraps>
...
80106200:	6a 4f                	push   $0x4f
  jmp alltraps
80106202:	e9 2f f8 ff ff       	jmp    80105a36 <alltraps>
...
80106209:	6a 50                	push   $0x50
  jmp alltraps
8010620b:	e9 26 f8 ff ff       	jmp    80105a36 <alltraps>
...
80106212:	6a 51                	push   $0x51
  jmp alltraps
80106214:	e9 1d f8 ff ff       	jmp    80105a36 <alltraps>
...
8010621b:	6a 52                	push   $0x52
  jmp alltraps
8010621d:	e9 14 f8 ff ff       	jmp    80105a36 <alltraps>
...
80106224:	6a 53                	push   $0x53
  jmp alltraps
80106226:	e9 0b f8 ff ff       	jmp    80105a36 <alltraps>
...
8010622d:	6a 54                	push   $0x54
  jmp alltraps
8010622f:	e9 02 f8 ff ff       	jmp    80105a36 <alltraps>
...
80106236:	6a 55                	push   $0x55
  jmp alltraps
80106238:	e9 f9 f7 ff ff       	jmp    80105a36 <alltraps>
...
8010623f:	6a 56                	push   $0x56
  jmp alltraps
80106241:	e9 f0 f7 ff ff       	jmp    80105a36 <alltraps>
...
80106248:	6a 57                	push   $0x57
  jmp alltraps
8010624a:	e9 e7 f7 ff ff       	jmp    80105a36 <alltraps>
...
80106251:	6a 58                	push   $0x58
  jmp alltraps
80106253:	e9 de f7 ff ff       	jmp    80105a36 <alltraps>
...
8010625a:	6a 59                	push   $0x59
  jmp alltraps
8010625c:	e9 d5 f7 ff ff       	jmp    80105a36 <alltraps>
...
80106263:	6a 5a                	push   $0x5a
  jmp alltraps
80106265:	e9 cc f7 ff ff       	jmp    80105a36 <alltraps>
...
8010626c:	6a 5b                	push   $0x5b
  jmp alltraps
8010626e:	e9 c3 f7 ff ff       	jmp    80105a36 <alltraps>
...
80106275:	6a 5c                	push   $0x5c
  jmp alltraps
80106277:	e9 ba f7 ff ff       	jmp    80105a36 <alltraps>
...
8010627e:	6a 5d                	push   $0x5d
  jmp alltraps
80106280:	e9 b1 f7 ff ff       	jmp    80105a36 <alltraps>
...
80106287:	6a 5e                	push   $0x5e
  jmp alltraps
80106289:	e9 a8 f7 ff ff       	jmp    80105a36 <alltraps>
...
80106290:	6a 5f                	push   $0x5f
  jmp alltraps
80106292:	e9 9f f7 ff ff       	jmp    80105a36 <alltraps>
...
80106299:	6a 60                	push   $0x60
  jmp alltraps
8010629b:	e9 96 f7 ff ff       	jmp    80105a36 <alltraps>
...
801062a2:	6a 61                	push   $0x61
  jmp alltraps
801062a4:	e9 8d f7 ff ff       	jmp    80105a36 <alltraps>
...
801062ab:	6a 62                	push   $0x62
  jmp alltraps
801062ad:	e9 84 f7 ff ff       	jmp    80105a36 <alltraps>
...
801062b4:	6a 63                	push   $0x63
  jmp alltraps
801062b6:	e9 7b f7 ff ff       	jmp    80105a36 <alltraps>
...
801062bd:	6a 64                	push   $0x64
  jmp alltraps
801062bf:	e9 72 f7 ff ff       	jmp    80105a36 <alltraps>
...
801062c6:	6a 65                	push   $0x65
  jmp alltraps
801062c8:	e9 69 f7 ff ff       	jmp    80105a36 <alltraps>
...
801062cf:	6a 66                	push   $0x66
  jmp alltraps
801062d1:	e9 60 f7 ff ff       	jmp    80105a36 <alltraps>
...
801062d8:	6a 67                	push   $0x67
  jmp alltraps
801062da:	e9 57 f7 ff ff       	jmp    80105a36 <alltraps>
...
801062e1:	6a 68                	push   $0x68
  jmp alltraps
801062e3:	e9 4e f7 ff ff       	jmp    80105a36 <alltraps>
...
801062ea:	6a 69                	push   $0x69
  jmp alltraps
801062ec:	e9 45 f7 ff ff       	jmp    80105a36 <alltraps>
...
801062f3:	6a 6a                	push   $0x6a
  jmp alltraps
801062f5:	e9 3c f7 ff ff       	jmp    80105a36 <alltraps>
...
801062fc:	6a 6b                	push   $0x6b
  jmp alltraps
801062fe:	e9 33 f7 ff ff       	jmp    80105a36 <alltraps>
...
80106305:	6a 6c                	push   $0x6c
  jmp alltraps
80106307:	e9 2a f7 ff ff       	jmp    80105a36 <alltraps>
...
8010630e:	6a 6d                	push   $0x6d
  jmp alltraps
80106310:	e9 21 f7 ff ff       	jmp    80105a36 <alltraps>
...
80106317:	6a 6e                	push   $0x6e
  jmp alltraps
80106319:	e9 18 f7 ff ff       	jmp    80105a36 <alltraps>
...
80106320:	6a 6f                	push   $0x6f
  jmp alltraps
80106322:	e9 0f f7 ff ff       	jmp    80105a36 <alltraps>
...
80106329:	6a 70                	push   $0x70
  jmp alltraps
8010632b:	e9 06 f7 ff ff       	jmp    80105a36 <alltraps>
...
80106332:	6a 71                	push   $0x71
  jmp alltraps
80106334:	e9 fd f6 ff ff       	jmp    80105a36 <alltraps>
...
8010633b:	6a 72                	push   $0x72
  jmp alltraps
8010633d:	e9 f4 f6 ff ff       	jmp    80105a36 <alltraps>
...
80106344:	6a 73                	push   $0x73
  jmp alltraps
80106346:	e9 eb f6 ff ff       	jmp    80105a36 <alltraps>
...
8010634d:	6a 74                	push   $0x74
  jmp alltraps
8010634f:	e9 e2 f6 ff ff       	jmp    80105a36 <alltraps>
...
80106356:	6a 75                	push   $0x75
  jmp alltraps
80106358:	e9 d9 f6 ff ff       	jmp    80105a36 <alltraps>
...
8010635f:	6a 76                	push   $0x76
  jmp alltraps
80106361:	e9 d0 f6 ff ff       	jmp    80105a36 <alltraps>
...
80106368:	6a 77                	push   $0x77
  jmp alltraps
8010636a:	e9 c7 f6 ff ff       	jmp    80105a36 <alltraps>
...
80106371:	6a 78                	push   $0x78
  jmp alltraps
80106373:	e9 be f6 ff ff       	jmp    80105a36 <alltraps>
...
8010637a:	6a 79                	push   $0x79
  jmp alltraps
8010637c:	e9 b5 f6 ff ff       	jmp    80105a36 <alltraps>
...
80106383:	6a 7a                	push   $0x7a
  jmp alltraps
80106385:	e9 ac f6 ff ff       	jmp    80105a36 <alltraps>
...
8010638c:	6a 7b                	push   $0x7b
  jmp alltraps
8010638e:	e9 a3 f6 ff ff       	jmp    80105a36 <alltraps>
...
80106395:	6a 7c                	push   $0x7c
  jmp alltraps
80106397:	e9 9a f6 ff ff       	jmp    80105a36 <alltraps>
...
8010639e:	6a 7d                	push   $0x7d
  jmp alltraps
801063a0:	e9 91 f6 ff ff       	jmp    80105a36 <alltraps>
...
801063a7:	6a 7e                	push   $0x7e
  jmp alltraps
801063a9:	e9 88 f6 ff ff       	jmp    80105a36 <alltraps>
...
801063b0:	6a 7f                	push   $0x7f
  jmp alltraps
801063b2:	e9 7f f6 ff ff       	jmp    80105a36 <alltraps>
...
801063b9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801063be:	e9 73 f6 ff ff       	jmp    80105a36 <alltraps>
...
801063c5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801063ca:	e9 67 f6 ff ff       	jmp    80105a36 <alltraps>
...
801063d1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801063d6:	e9 5b f6 ff ff       	jmp    80105a36 <alltraps>
...
801063dd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801063e2:	e9 4f f6 ff ff       	jmp    80105a36 <alltraps>
...
801063e9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801063ee:	e9 43 f6 ff ff       	jmp    80105a36 <alltraps>
...
801063f5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801063fa:	e9 37 f6 ff ff       	jmp    80105a36 <alltraps>
...
80106401:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106406:	e9 2b f6 ff ff       	jmp    80105a36 <alltraps>
...
8010640d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106412:	e9 1f f6 ff ff       	jmp    80105a36 <alltraps>
...
80106419:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010641e:	e9 13 f6 ff ff       	jmp    80105a36 <alltraps>
...
80106425:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010642a:	e9 07 f6 ff ff       	jmp    80105a36 <alltraps>
...
80106431:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106436:	e9 fb f5 ff ff       	jmp    80105a36 <alltraps>
...
8010643d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106442:	e9 ef f5 ff ff       	jmp    80105a36 <alltraps>
...
80106449:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010644e:	e9 e3 f5 ff ff       	jmp    80105a36 <alltraps>
...
80106455:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010645a:	e9 d7 f5 ff ff       	jmp    80105a36 <alltraps>
...
80106461:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106466:	e9 cb f5 ff ff       	jmp    80105a36 <alltraps>
...
8010646d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106472:	e9 bf f5 ff ff       	jmp    80105a36 <alltraps>
...
80106479:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010647e:	e9 b3 f5 ff ff       	jmp    80105a36 <alltraps>
...
80106485:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010648a:	e9 a7 f5 ff ff       	jmp    80105a36 <alltraps>
...
80106491:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106496:	e9 9b f5 ff ff       	jmp    80105a36 <alltraps>
...
8010649d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801064a2:	e9 8f f5 ff ff       	jmp    80105a36 <alltraps>
...
801064a9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801064ae:	e9 83 f5 ff ff       	jmp    80105a36 <alltraps>
...
801064b5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801064ba:	e9 77 f5 ff ff       	jmp    80105a36 <alltraps>
...
801064c1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801064c6:	e9 6b f5 ff ff       	jmp    80105a36 <alltraps>
...
801064cd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801064d2:	e9 5f f5 ff ff       	jmp    80105a36 <alltraps>
...
801064d9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801064de:	e9 53 f5 ff ff       	jmp    80105a36 <alltraps>
...
801064e5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801064ea:	e9 47 f5 ff ff       	jmp    80105a36 <alltraps>
...
801064f1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801064f6:	e9 3b f5 ff ff       	jmp    80105a36 <alltraps>
...
801064fd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106502:	e9 2f f5 ff ff       	jmp    80105a36 <alltraps>
...
80106509:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010650e:	e9 23 f5 ff ff       	jmp    80105a36 <alltraps>
...
80106515:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010651a:	e9 17 f5 ff ff       	jmp    80105a36 <alltraps>
...
80106521:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106526:	e9 0b f5 ff ff       	jmp    80105a36 <alltraps>
...
8010652d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106532:	e9 ff f4 ff ff       	jmp    80105a36 <alltraps>
...
80106539:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010653e:	e9 f3 f4 ff ff       	jmp    80105a36 <alltraps>
...
80106545:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010654a:	e9 e7 f4 ff ff       	jmp    80105a36 <alltraps>
...
80106551:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106556:	e9 db f4 ff ff       	jmp    80105a36 <alltraps>
...
8010655d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106562:	e9 cf f4 ff ff       	jmp    80105a36 <alltraps>
...
80106569:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010656e:	e9 c3 f4 ff ff       	jmp    80105a36 <alltraps>
...
80106575:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010657a:	e9 b7 f4 ff ff       	jmp    80105a36 <alltraps>
...
80106581:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106586:	e9 ab f4 ff ff       	jmp    80105a36 <alltraps>
...
8010658d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106592:	e9 9f f4 ff ff       	jmp    80105a36 <alltraps>
...
80106599:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010659e:	e9 93 f4 ff ff       	jmp    80105a36 <alltraps>
...
801065a5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801065aa:	e9 87 f4 ff ff       	jmp    80105a36 <alltraps>
...
801065b1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801065b6:	e9 7b f4 ff ff       	jmp    80105a36 <alltraps>
...
801065bd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801065c2:	e9 6f f4 ff ff       	jmp    80105a36 <alltraps>
...
801065c9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801065ce:	e9 63 f4 ff ff       	jmp    80105a36 <alltraps>
...
801065d5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801065da:	e9 57 f4 ff ff       	jmp    80105a36 <alltraps>
...
801065e1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801065e6:	e9 4b f4 ff ff       	jmp    80105a36 <alltraps>
...
801065ed:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801065f2:	e9 3f f4 ff ff       	jmp    80105a36 <alltraps>
...
801065f9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801065fe:	e9 33 f4 ff ff       	jmp    80105a36 <alltraps>
...
80106605:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010660a:	e9 27 f4 ff ff       	jmp    80105a36 <alltraps>
...
80106611:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106616:	e9 1b f4 ff ff       	jmp    80105a36 <alltraps>
...
8010661d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106622:	e9 0f f4 ff ff       	jmp    80105a36 <alltraps>
...
80106629:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010662e:	e9 03 f4 ff ff       	jmp    80105a36 <alltraps>
...
80106635:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010663a:	e9 f7 f3 ff ff       	jmp    80105a36 <alltraps>
...
80106641:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106646:	e9 eb f3 ff ff       	jmp    80105a36 <alltraps>
...
8010664d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106652:	e9 df f3 ff ff       	jmp    80105a36 <alltraps>
...
80106659:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010665e:	e9 d3 f3 ff ff       	jmp    80105a36 <alltraps>
...
80106665:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010666a:	e9 c7 f3 ff ff       	jmp    80105a36 <alltraps>
...
80106671:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106676:	e9 bb f3 ff ff       	jmp    80105a36 <alltraps>
...
8010667d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106682:	e9 af f3 ff ff       	jmp    80105a36 <alltraps>
...
80106689:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010668e:	e9 a3 f3 ff ff       	jmp    80105a36 <alltraps>
...
80106695:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010669a:	e9 97 f3 ff ff       	jmp    80105a36 <alltraps>
...
801066a1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801066a6:	e9 8b f3 ff ff       	jmp    80105a36 <alltraps>
...
801066ad:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801066b2:	e9 7f f3 ff ff       	jmp    80105a36 <alltraps>
...
801066b9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801066be:	e9 73 f3 ff ff       	jmp    80105a36 <alltraps>
...
801066c5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801066ca:	e9 67 f3 ff ff       	jmp    80105a36 <alltraps>
...
801066d1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801066d6:	e9 5b f3 ff ff       	jmp    80105a36 <alltraps>
...
801066dd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801066e2:	e9 4f f3 ff ff       	jmp    80105a36 <alltraps>
...
801066e9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801066ee:	e9 43 f3 ff ff       	jmp    80105a36 <alltraps>
...
801066f5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801066fa:	e9 37 f3 ff ff       	jmp    80105a36 <alltraps>
...
80106701:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106706:	e9 2b f3 ff ff       	jmp    80105a36 <alltraps>
...
8010670d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106712:	e9 1f f3 ff ff       	jmp    80105a36 <alltraps>
...
80106719:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010671e:	e9 13 f3 ff ff       	jmp    80105a36 <alltraps>
...
80106725:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010672a:	e9 07 f3 ff ff       	jmp    80105a36 <alltraps>
...
80106731:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106736:	e9 fb f2 ff ff       	jmp    80105a36 <alltraps>
...
8010673d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106742:	e9 ef f2 ff ff       	jmp    80105a36 <alltraps>
...
80106749:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010674e:	e9 e3 f2 ff ff       	jmp    80105a36 <alltraps>
...
80106755:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010675a:	e9 d7 f2 ff ff       	jmp    80105a36 <alltraps>
...
80106761:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106766:	e9 cb f2 ff ff       	jmp    80105a36 <alltraps>
...
8010676d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106772:	e9 bf f2 ff ff       	jmp    80105a36 <alltraps>
...
80106779:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010677e:	e9 b3 f2 ff ff       	jmp    80105a36 <alltraps>
...
80106785:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010678a:	e9 a7 f2 ff ff       	jmp    80105a36 <alltraps>
...
80106791:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106796:	e9 9b f2 ff ff       	jmp    80105a36 <alltraps>
...
8010679d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801067a2:	e9 8f f2 ff ff       	jmp    80105a36 <alltraps>
...
801067a9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801067ae:	e9 83 f2 ff ff       	jmp    80105a36 <alltraps>
...
801067b5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801067ba:	e9 77 f2 ff ff       	jmp    80105a36 <alltraps>
...
801067c1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801067c6:	e9 6b f2 ff ff       	jmp    80105a36 <alltraps>
...
801067cd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801067d2:	e9 5f f2 ff ff       	jmp    80105a36 <alltraps>
...
801067d9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801067de:	e9 53 f2 ff ff       	jmp    80105a36 <alltraps>
...
801067e5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801067ea:	e9 47 f2 ff ff       	jmp    80105a36 <alltraps>
...
801067f1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801067f6:	e9 3b f2 ff ff       	jmp    80105a36 <alltraps>
...
801067fd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106802:	e9 2f f2 ff ff       	jmp    80105a36 <alltraps>
...
80106809:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010680e:	e9 23 f2 ff ff       	jmp    80105a36 <alltraps>
...
80106815:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010681a:	e9 17 f2 ff ff       	jmp    80105a36 <alltraps>
...
80106821:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106826:	e9 0b f2 ff ff       	jmp    80105a36 <alltraps>
...
8010682d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106832:	e9 ff f1 ff ff       	jmp    80105a36 <alltraps>
...
80106839:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010683e:	e9 f3 f1 ff ff       	jmp    80105a36 <alltraps>
...
80106845:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010684a:	e9 e7 f1 ff ff       	jmp    80105a36 <alltraps>
...
80106851:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106856:	e9 db f1 ff ff       	jmp    80105a36 <alltraps>
...
8010685d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106862:	e9 cf f1 ff ff       	jmp    80105a36 <alltraps>
...
80106869:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010686e:	e9 c3 f1 ff ff       	jmp    80105a36 <alltraps>
...
80106875:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010687a:	e9 b7 f1 ff ff       	jmp    80105a36 <alltraps>
...
80106881:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106886:	e9 ab f1 ff ff       	jmp    80105a36 <alltraps>
...
8010688d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106892:	e9 9f f1 ff ff       	jmp    80105a36 <alltraps>
...
80106899:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010689e:	e9 93 f1 ff ff       	jmp    80105a36 <alltraps>
...
801068a5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801068aa:	e9 87 f1 ff ff       	jmp    80105a36 <alltraps>
...
801068b1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801068b6:	e9 7b f1 ff ff       	jmp    80105a36 <alltraps>
...
801068bd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801068c2:	e9 6f f1 ff ff       	jmp    80105a36 <alltraps>
...
801068c9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801068ce:	e9 63 f1 ff ff       	jmp    80105a36 <alltraps>
...
801068d5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801068da:	e9 57 f1 ff ff       	jmp    80105a36 <alltraps>
...
801068e1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801068e6:	e9 4b f1 ff ff       	jmp    80105a36 <alltraps>
...
801068ed:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801068f2:	e9 3f f1 ff ff       	jmp    80105a36 <alltraps>
...
801068f9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801068fe:	e9 33 f1 ff ff       	jmp    80105a36 <alltraps>
...
80106905:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010690a:	e9 27 f1 ff ff       	jmp    80105a36 <alltraps>
...
80106911:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106916:	e9 1b f1 ff ff       	jmp    80105a36 <alltraps>
...
8010691d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106922:	e9 0f f1 ff ff       	jmp    80105a36 <alltraps>
...
80106929:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010692e:	e9 03 f1 ff ff       	jmp    80105a36 <alltraps>
...
80106935:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010693a:	e9 f7 f0 ff ff       	jmp    80105a36 <alltraps>
...
80106941:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106946:	e9 eb f0 ff ff       	jmp    80105a36 <alltraps>
...
8010694d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106952:	e9 df f0 ff ff       	jmp    80105a36 <alltraps>
...
80106959:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010695e:	e9 d3 f0 ff ff       	jmp    80105a36 <alltraps>
...
80106965:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010696a:	e9 c7 f0 ff ff       	jmp    80105a36 <alltraps>
...
80106971:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106976:	e9 bb f0 ff ff       	jmp    80105a36 <alltraps>
...
8010697d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106982:	e9 af f0 ff ff       	jmp    80105a36 <alltraps>
...
80106989:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010698e:	e9 a3 f0 ff ff       	jmp    80105a36 <alltraps>
...
80106995:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010699a:	e9 97 f0 ff ff       	jmp    80105a36 <alltraps>
...
801069a1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801069a6:	e9 8b f0 ff ff       	jmp    80105a36 <alltraps>
...
801069ad:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801069b2:	e9 7f f0 ff ff       	jmp    80105a36 <alltraps>
...
801069da:	73 45                	jae    80106a21 <deallocuvm.part.0+0x61>
801069dc:	89 c7                	mov    %eax,%edi
801069de:	eb 0a                	jmp    801069ea <deallocuvm.part.0+0x2a>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801069e0:	8d 59 01             	lea    0x1(%ecx),%ebx
801069e3:	c1 e3 16             	shl    $0x16,%ebx
  for(; a  < oldsz; a += PGSIZE){
801069e6:	39 da                	cmp    %ebx,%edx
801069e8:	76 37                	jbe    80106a21 <deallocuvm.part.0+0x61>
  pde = &pgdir[PDX(va)];
801069ea:	89 d9                	mov    %ebx,%ecx
801069ec:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
801069ef:	8b 04 8f             	mov    (%edi,%ecx,4),%eax
801069f2:	a8 01                	test   $0x1,%al
801069f4:	74 ea                	je     801069e0 <deallocuvm.part.0+0x20>
  return &pgtab[PTX(va)];
801069f6:	89 de                	mov    %ebx,%esi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801069f8:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
801069fd:	c1 ee 0a             	shr    $0xa,%esi
80106a00:	81 e6 fc 0f 00 00    	and    $0xffc,%esi
80106a06:	8d b4 30 00 00 00 80 	lea    -0x80000000(%eax,%esi,1),%esi
    if(!pte)
80106a0d:	85 f6                	test   %esi,%esi
80106a0f:	74 cf                	je     801069e0 <deallocuvm.part.0+0x20>
    else if((*pte & PTE_P) != 0){
80106a11:	8b 06                	mov    (%esi),%eax
80106a13:	a8 01                	test   $0x1,%al
80106a15:	75 19                	jne    80106a30 <deallocuvm.part.0+0x70>
  for(; a  < oldsz; a += PGSIZE){
80106a17:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106a1d:	39 da                	cmp    %ebx,%edx
80106a1f:	77 c9                	ja     801069ea <deallocuvm.part.0+0x2a>
      kfree(v);
      *pte = 0;
    }
  }
...
80106a21:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106a24:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106a27:	5b                   	pop    %ebx
80106a28:	5e                   	pop    %esi
80106a29:	5f                   	pop    %edi
80106a2a:	5d                   	pop    %ebp
...
80106aee:	e8 9d bc ff ff       	call   80102790 <kalloc>
...
80106b05:	e8 76 dc ff ff       	call   80104780 <memset>
...
80106b63:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106b66:	e8 05 cf ff ff       	call   80103a70 <cpuid>
  pd[0] = size-1;
...
80106bf0:	a1 c4 44 11 80       	mov    0x801144c4,%eax
...
80106c24:	0f 84 c2 00 00 00    	je     80106cec <switchuvm+0xec>
  pushcli();
80106c2a:	e8 41 d9 ff ff       	call   80104570 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106c2f:	e8 cc cd ff ff       	call   80103a00 <mycpu>
80106c34:	89 c3                	mov    %eax,%ebx
80106c36:	e8 c5 cd ff ff       	call   80103a00 <mycpu>
80106c3b:	89 c7                	mov    %eax,%edi
80106c3d:	e8 be cd ff ff       	call   80103a00 <mycpu>
80106c42:	83 c7 08             	add    $0x8,%edi
80106c45:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c48:	e8 b3 cd ff ff       	call   80103a00 <mycpu>
...
80106cd9:	5d                   	pop    %ebp
  popcli();
80106cda:	e9 e1 d8 ff ff       	jmp    801045c0 <popcli>
...
80106d2b:	77 4b                	ja     80106d78 <inituvm+0x68>
  mem = kalloc();
80106d2d:	e8 5e ba ff ff       	call   80102790 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106d3f:	e8 3c da ff ff       	call   80104780 <memset>
...
80106d72:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d73:	e9 a8 da ff ff       	jmp    80104820 <memmove>
...
80106e2e:	e8 6d ad ff ff       	call   80101ba0 <readi>
...
80106ef9:	76 48                	jbe    80106f43 <allocuvm+0xc3>
    mem = kalloc();
80106efb:	e8 90 b8 ff ff       	call   80102790 <kalloc>
...
80106f0e:	e8 6d 97 ff ff       	call   80100680 <cprintf>
  if(newsz >= oldsz)
...
80106f70:	e8 0b 97 ff ff       	call   80100680 <cprintf>
  if(newsz >= oldsz)
...
80106f90:	e8 3b b6 ff ff       	call   801025d0 <kfree>
      return 0;
...
8010702e:	e8 9d b5 ff ff       	call   801025d0 <kfree>
...
80107043:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107044:	e9 87 b5 ff ff       	jmp    801025d0 <kfree>
    panic("freevm: no pgdir");
...
80107065:	e8 26 b7 ff ff       	call   80102790 <kalloc>
...
80107091:	ff 73 0c             	pushl  0xc(%ebx)
...
801070eb:	a3 c4 44 11 80       	mov    %eax,0x801144c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801071cf:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
801071d5:	e8 b6 b5 ff ff       	call   80102790 <kalloc>
...
801071f0:	e8 2b d6 ff ff       	call   80104820 <memmove>
...
8010723c:	e8 8f b3 ff ff       	call   801025d0 <kfree>
      goto bad;
...
8010731b:	01 c8                	add    %ecx,%eax
8010731d:	53                   	push   %ebx
8010731e:	52                   	push   %edx
8010731f:	50                   	push   %eax
80107320:	e8 fb d4 ff ff       	call   80104820 <memmove>
    len -= n;
    buf += n;
